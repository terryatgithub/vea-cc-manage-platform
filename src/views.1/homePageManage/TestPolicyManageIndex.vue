...
<script>
import PolicyManageList from  './TestPolicyManageList'
import PolicyManageAdd from './TestPolicyManageAdd'
import PolicyManagePreview from './TestPolicyManagePreview'
