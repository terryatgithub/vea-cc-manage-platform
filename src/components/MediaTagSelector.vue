...
export default {
  ...
  methods: {
      ...
      setTagNodeUrl(perId) {
          ...
          $.each(_this.tagNodeUrl, function (i, item) {
              if (item.perId === perId) {
              ...
              .then((data) => {
                  if (_this.tagNodeIndex >= nIndex) {
                      ...
                      if (data.data.rows.length > 0) {
                          ...
                          $.each(_this.tagData[_this.tagNodeIndex].child, function (i, item) {
                              $.each(_this.movieTags, function (t, tag) {
                  ...
                  let tagNodes = [];
                  $.each(_this.tagData, function (i, item) {
      ...
      changeTag: function (index, tags) {
          ...
          if (tagDataBakNode.length > tagDataNode.length) {
              //减
              $.each(tagDataBakNode, function (t, tag) {
                  let flag = true;
                  $.each(tagDataNode, function (i, item) {
                  ...
                  if (flag && tag.nodeType === 1) {
                      $.each(_this.movieTags, function (i, item) {
                          if (tag.tagCode === item.tagCode) {
              ...
              if (tagLast.nodeType === 1) {
                  $.each(_this.movieTags, function (i, tag) {
      ...
      clickCheckedTagNode: function (index, tag) {
          ...
          let flag = true;
          $.each(_this.tagData[index].tagNode, function (i, item) {
              if (tag.tagCode === item.tagCode) {
                  _this.tagData[index].tagNode.splice(i, 1);
                  flag = false;
                  return false
