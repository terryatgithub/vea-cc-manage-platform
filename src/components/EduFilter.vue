        ...
        <el-form :inline="true" v-model="searchForm" label-width="72px">
          <el-form-item label="内容商">
            <el-select filterable v-model="searchForm.contentProviders" size="small">
              ...
              <el-option
                v-for="provider in conditionList.contentProviders"
                :key="provider.tagCnName"
                :label="provider.tagCnName"
                :value="provider.tagCnName"
              ></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="教育分类">
            <el-select
              v-model="searchForm.teachTypes"
              @change="teachTypesSelectChange"
              size="small"
            >
              <el-option label="请选择" value></el-option>
              <el-option
                v-for="teachType in teachTypes"
                :key="teachType.categoryName"
                :label="teachType.categoryName"
                :value="teachType.categoryName"
              ></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="年级年龄">
            <el-select v-model="searchForm.gradeList" size="small" placeholder="请选择教育分类">
              ...
              <el-option
                ...
                :key="grade.tagId"
                :label="grade.tagCnName"
                :value="grade.tagCnName"
              ></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="内容分类">
            <el-select
              filterable
              v-model="searchForm.videoTypes"
              size="small"
              placeholder="请选择教育分类"
            >
              <el-option label="请选择/输入" value></el-option>
              <el-option
                v-for="videoType in eduTypes"
                :key="videoType.tagName"
          ...
          <span v-show="isMore">
            <el-form-item label="课程版本">
              <el-select filterable v-model="searchForm.courseVersion" size="small">
                <el-option label="请选择/输入" value></el-option>
                <el-option
                  v-for="version in conditionList.courseVersion"
                  :key="version.tagId"
                  :label="version.tagCnName"
                  :value="version.tagCnName"
                ></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="集数">
              <el-select filterable v-model="searchForm.segmentTag" size="small">
                <el-option label="请选择/输入" value></el-option>
                <el-option
                  v-for="tag in conditionList.segmentTag"
                  :key="tag.tagEnName"
                  :label="tag.tagCnName"
                  :value="tag.tagEnName"
                ></el-option>
...
export default {
  ...
  methods: {
    teachTypesSelectChange: function(categoryName) {
      ...
      // 改变内容分类
      this.eduTypes = teachTypes[tIndex]
        ? teachTypes[tIndex].child[0].tagEntities
        : []
