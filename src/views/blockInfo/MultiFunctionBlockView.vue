       ...
       <div class="multi-func-block-read" >    
        ...
        <el-form ref="blockForm" label-width="140px">
            ...
            <el-form-item 
                ...
                label="内容源">
                {{ SOURCE_TEXT[block.pluginInfo.source] }}
            </el-form-item>
            <template v-if="pluginParentType === 'sign'">
                <el-form-item label="标记推荐位类型" prop="pluginInfo.pluginType">
                    {{ block.pluginInfo.pluginType }}
                </el-form-item>
            </template>
            <el-form-item 
            ...
            <template  v-if="baseHasTitle">
                <el-form-item label="标题" prop="helper.title">
                    {{ block.helper.title }}
                </el-form-item>
                <el-form-item label="副标题" prop="helper.subTitle">
                    {{ block.helper.subTitle }}
                </el-form-item>
            </template>
            <template v-if="pluginParentType !== 'sign'">
            <div  v-for="(item, index) in block.rlsInfo" :key="index" >
                ...
                <template v-if=" pluginType === 'REFERENCE_ACTIVITY'">
                    ...
                    <el-form-item  label="存活时间">
                        {{ parseMinToStr(item.extendInfo.aliveTime) }}
                    </el-form-item>
                    <el-form-item 
                        label="点击次数">
                        {{ item.extendInfo.clickCount}}
                    </el-form-item>
                </template>
                <el-form-item   v-if="pluginParentType === 'multi' || pluginParentType === 'secKill'"   label="打开方式">
                    {{ OPEN_MODE_TEXT[item.openMode] }}
                </el-form-item>
                <template v-if="item.openMode === 'webpage'">
                    <el-form-item  label="网页地址"> {{ item.onclick.webpageUrl }}
                    </el-form-item>
                    <el-form-item label="网页类型">
                        {{ ['', '浮窗网页', '全屏网页'][+item.onclick.webpageType] }}
                    </el-form-item>
                    <el-form-item label="应用版本号">
                        {{ item.onclick.webpageAppVersion }}
                    </el-form-item>
                </template>
                <template v-if="item.openMode === 'video'">
                    <el-form-item label="视频名称">
                        {{ item.onclick.videoName }}
                    </el-form-item>
                    <el-form-item label="视频地址">
                        {{ item.onclick.videoUrl }}
                    </el-form-item>
                </template>
