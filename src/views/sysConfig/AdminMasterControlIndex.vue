...
export default {
  data: function () {
    return {
      ...
      rules: {
        openCache: [{ required: true, message: '请选择是否开启缓存', trigger: 'blur' }],
        cacheVersion: [{ required: true, message: '请输入缓存版本', trigger: 'blur' }],
        mediaRecallPolicy: [{ required: true, message: '请选择媒资回溯策略', trigger: 'blur' }]
      }
    }
  },
  methods: {
